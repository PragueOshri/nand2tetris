...
public class JackTokenizer {
    ...
    int whitespacesFromPrevToken;
    int prevTokenStartIndex;
    ...
    public void goBack(){
        nextTokenStartIndex = prevTokenStartIndex;
        advanceToNextTokenInCurLine();
    }
    ...
    private void storePrevTokenBeforeAdvance(){
        if (currentToken != null)
            prevTokenStartIndex = nextTokenStartIndex - whitespacesFromPrevToken - currentToken.length();
    }
